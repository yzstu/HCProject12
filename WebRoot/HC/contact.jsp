  ...
  <tr>
    <td height="40" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="2" align="center"><img src="images/top_22.png" width="2" height="40" /></td>
        <td width="130" align="center" bgcolor="#076f9b"><a href="contact.jsp" class="dao">反馈中心</a></td>
        <td width="2" align="center" ><img src="images/top_22.png" width="2" height="40" /></td>
        <td align="center">&nbsp;</td>
      </tr>
    </table></td>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="1000" height="190" valign="middle"><img src="images/contact_03.jpg" width="1000" height="150" /></td>
  </tr>
</table>
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="212" valign="top"><table border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF" class="bk_e4e4e4">
      <tr>
        <td width="190"><table border="0" cellspacing="10" cellpadding="0">
          <tr>
            <td align="right"><span  class="font_18 fotn_999">联系我们</span><br />
                <span class="font_0A8BC4  font_24">Contact us</span></td>
          </tr>
          <tr>
            <td height="27" align="left" background="images/left_07.jpg" class="font_fff" style=" padding-left:10px;">联系方式</td>
          </tr>
          <tr>
    ...
    <td width="768" valign="top" bgcolor="#FFFFFF" class="bk_e4e4e4"><table width="100%" border="0" cellspacing="10" cellpadding="0">
      <tr>
        ...
        <tr>
        <td height="30" align="left" class="font_14"><strong class="font_16">提出建议</strong>
        <form method="post" action="<%=basePath%>suggestServlet?account=${account }">
        <textarea name="suggest" cols="30" rows="4" style="width: 754px; "></textarea>
        <input type="submit" value="提交">
        <input type="reset" value="取消">
        <br><strong class="font_16">${empty msg?"":msg }</strong>
        </form>
        </td>
        </tr>
          <tr>
            <td height="30" align="left" class="font_14"><strong class="font_16">联系方式</strong></td>
          </tr>
          <tr>
            <td height="3" background="images/about_49.jpg"></td>
          </tr>
          <tr>
            <td valign="top"><table border="0" align="center" cellpadding="0" cellspacing="15">
              <tr>
                <td><span class="font_0A8BC4 font_14"><strong>华成农贸资讯有限公司</strong></span><br />
                  电话：400-027-3552<br />
         QQ：021-61076293<br />
                  地址：长江大学东校区小西门斜对面汉科十巷9号1楼 <br />
         </td>
              </tr>
              <tr>
                <td><img src="images/contact_07.jpg" width="675" height="289" /></td>
              </tr>
            </table></td>
          </tr>
