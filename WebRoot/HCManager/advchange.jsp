...
<body>
	<div id="pageAll">
		...
		<div class="page ">
			<form action="<%=basePath%>changeAdvertisingServlet?no=<%=no %>" method="post"
				...
				<div class="banneradd bor">
					...
					<div class="baBody">
						<div class="bbD">
							链接名称：<input type="text" class="input1" name="name" />
						</div>
						<div class="bbD">
						...
						<div class="bbD">
							...
							<div class="bbDd">
		 						<div  class="bbDImg">
									<!--设置一个框放图片-->
									<img id="image" width="100%" height="100%" src="../<%=imgUrl %>" />
									<!--放图片的标签-->
						...
						<div class="bbD">
							<p class="bbDP">
								...
								<a class="btn_ok btn_no" href="HCManager/advertisingShowServlet">取消</a>
							</p>
						</div>
					</div>
				</div>
